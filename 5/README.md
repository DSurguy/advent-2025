...
To run the example from the day 5 instructions, pass `--example` as an argument: `bun run 5 --example` or `bun index.ts --example`. ~~The solutions for the included example should be `13` and `43`.~~
